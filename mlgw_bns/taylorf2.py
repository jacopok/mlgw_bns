...
def TaylorF2(
    ...
    if Lam1 != 0.0 or Lam2 != 0.0:
        ...
        if usequadrupolemonopole:
            PhiQM = PhifQM3hPN(f, M, eta, s1x, s1y, s1z, s2x, s2y, s2z, Lam1, Lam2)
        PhiT += PhiQM
...
def taylorf2_wrapper(freqs, params, phaseorder=11, tidalorder=15, useqm=1):
    """
